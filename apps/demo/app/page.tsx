		...
		<main className={styles.page}>
			<section className={styles.hero}>
				...
				<div className={styles.actions}>
					...
					<Link href="/collab" className={styles.secondary}>
						Open collaboration demo
					</Link>
				</div>
			</section>
				...
				<article className={styles.card}>
					...
					<ul className={styles.list}>
						...
						<li>
							...
							between the Bento Grid and the stats strip.
						</li>
						<li>
						...
						<li>
							`@anvilkit/blog-list` adds the editorial card grid that mirrors
							the new publishable blog summary package.
						</li>
						<li>
