    ...
    <main className={styles.shell}>
      <section className={styles.masthead}>
        <div>
          ...
          <h1 className={styles.title}>Server-safe rendering with the same component config.</h1>
          <p className={styles.lede}>
            This route renders the shared demo data with `Render` from `@puckeditor/core/rsc`, using
            the same package-level component configs as the editor view.
          </p>
        </div>
