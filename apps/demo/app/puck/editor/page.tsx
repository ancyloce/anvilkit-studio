			...
			<section className={styles.masthead}>
				<div>
					...
					<h1 className={styles.title}>
						Puck editor mode for the shared navbar, hero, section, statistics,
						and logo cloud demo.
					</h1>
					<p className={styles.lede}>
						This route uses the real package exports from `@anvilkit/navbar` and
						`@anvilkit/hero`, plus `@anvilkit/section`,
				...
				<main className={styles.shell}>
					<section className={styles.masthead}>
						<div>
							...
							<p className={styles.lede}>
								Preparing the shared navbar, hero, section, statistics, and
								logo cloud demo payload.
							</p>
						</div>
						<div className={styles.actions}>
							<Link href="/" className={styles.secondaryAction}>
