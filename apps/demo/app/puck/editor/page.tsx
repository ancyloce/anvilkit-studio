			...
			<section className={styles.masthead}>
				<div>
					...
					<h1 className={styles.title}>
						...
						statistics, blog list, helps, and logo cloud demo.
					</h1>
					<p className={styles.lede}>
						...
						`@anvilkit/statistics`, `@anvilkit/blog-list`, `@anvilkit/helps`,
						and `@anvilkit/logo-clouds`, composed into the same consumer-owned
						Puck `Config` used by render mode.
					</p>
				</div>
