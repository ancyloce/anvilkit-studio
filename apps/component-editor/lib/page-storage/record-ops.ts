 ...
 *
 * `record-ops` is the one place a `EditorPageData` is read and rebuilt, so it is
...
function rootPropsOf(data: EditorPageData): PageRootProps | undefined {
