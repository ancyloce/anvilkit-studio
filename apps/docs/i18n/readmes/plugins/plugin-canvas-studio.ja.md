...
peer 依存関係：`@anvilkit/canvas-core`、`@anvilkit/canvas-editor`、`@puckeditor/core ^0.23.0`、`react >=19.0.0`、`react-dom >=19.0.0`。（`@anvilkit/core`、`@anvilkit/design-block`、`@anvilkit/plugin-asset-manager` は直接依存関係として同梱されます。）
