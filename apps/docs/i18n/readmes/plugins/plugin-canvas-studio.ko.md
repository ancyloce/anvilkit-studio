...
peer 의존성: `@anvilkit/canvas-core`, `@anvilkit/canvas-editor`, `@puckeditor/core ^0.22.2`, `react >=19.0.0`, `react-dom >=19.0.0`. (`@anvilkit/core`, `@anvilkit/design-block`, `@anvilkit/plugin-asset-manager`는 직접 의존성으로 동봉됩니다.)
