...
对等依赖：`@anvilkit/canvas-core`、`@anvilkit/canvas-editor`、`@puckeditor/core ^0.22.1`、`react >=19.0.0`、`react-dom >=19.0.0`。（`@anvilkit/core`、`@anvilkit/design-block` 和 `@anvilkit/plugin-asset-manager` 作为直接依赖随包发布。）
