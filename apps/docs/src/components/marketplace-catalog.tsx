...
/**
 * Filterable marketplace catalog — ported verbatim from the live Astro docs
 * island (apps/docs/src/components/MarketplaceCatalog.tsx). Pure React
 * (useState/useMemo), SSR-friendly, so it renders server-side and hydrates.
 * E2E test-ids (marketplace-root, marketplace-grid, filter-*, card-*) are
 * preserved for the Phase 3 Playwright port.
 */
