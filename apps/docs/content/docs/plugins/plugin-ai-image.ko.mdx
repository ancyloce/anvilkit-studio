...
| `AiDesignJobError` | 타입 |
| `AiDesignJobKind` | 타입 |
| `AiDesignJobPayload` | 타입 |
| `AiDesignJobRequest` | 타입 |
| `AiDesignJobResult` | 타입 |
| `AiDesignJobStatus` | 타입 |
| `AiDesignProvider` | 타입 |
| `AiDesignProviderOptions` | 타입 |
| `AiDesignQuarantineError` | 타입 |
| `AiImageBackgroundReplaceRequest` | 타입 |
| `AiImageBgRemoveRequest` | 타입 |
| `AiImageGenerativeExpandRequest` | 타입 |
| `AiImageGenerativeFillRequest` | 타입 |
...
| `AiLayerBounds` | 타입 |
| `AiLayerContext` | 타입 |
| `AiProviderCapabilities` | 타입 |
| `BrandKitDefinition` | 타입 |
| `CanvasFactory` | 타입 |
| `CommitAiDesignCommandFn` | 타입 |
| `CommitAiDesignResultOptions` | 타입 |
| `CommitAiDesignResultOutcome` | 타입 |
