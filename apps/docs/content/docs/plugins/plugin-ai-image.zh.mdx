...
| `AiDesignJobError` | 类型 |
| `AiDesignJobKind` | 类型 |
| `AiDesignJobPayload` | 类型 |
| `AiDesignJobRequest` | 类型 |
| `AiDesignJobResult` | 类型 |
| `AiDesignJobStatus` | 类型 |
| `AiDesignProvider` | 类型 |
| `AiDesignProviderOptions` | 类型 |
| `AiDesignQuarantineError` | 类型 |
| `AiImageBackgroundReplaceRequest` | 类型 |
| `AiImageBgRemoveRequest` | 类型 |
| `AiImageGenerativeExpandRequest` | 类型 |
| `AiImageGenerativeFillRequest` | 类型 |
...
| `AiLayerBounds` | 类型 |
| `AiLayerContext` | 类型 |
| `AiProviderCapabilities` | 类型 |
| `BrandKitDefinition` | 类型 |
| `CanvasFactory` | 类型 |
| `CommitAiDesignCommandFn` | 类型 |
| `CommitAiDesignResultOptions` | 类型 |
| `CommitAiDesignResultOutcome` | 类型 |
