...
<div className="anvilkit-plugin-meta">
	<code>@anvilkit/plugin-version-history</code> <span>·</span> <span>v0.1.8</span> <span>·</span> <span>기록</span> <span>·</span> <span>헤더 액션</span>
</div>
...
| `MaybePromise` | 타입 |
| `PeerInfo` | 타입 |
| `PrepareRestoreInput` | 타입 |
| `PresenceCursor` | 타입 |
| `PresenceSelection` | 타입 |
| `PresenceState` | 타입 |
| `RestoreConflict` | 타입 |
| `RestoreConflictInput` | 타입 |
| `RetentionAdapter` | 타입 |
| `RetentionPlan` | 타입 |
| `RetentionPlanOptions` | 타입 |
| `RetentionPolicy` | 타입 |
| `RetentionResult` | 타입 |
| `RunRetentionOptions` | 타입 |
| `SnapshotAdapter` | 타입 |
| `SnapshotAdapterPresence` | 타입 |
| `SnapshotMeta` | 타입 |
| `SnapshotMetaPatch` | 타입 |
| `SnapshotPage` | 타입 |
| `SnapshotQuery` | 타입 |
| `Unsubscribe` | 타입 |
| `VersionHistoryErrorCode` | 타입 |
| `VersionHistoryExport` | 타입 |
| `VersionHistoryExportEntry` | 타입 |
| `VersionHistoryImportOptions` | 타입 |
| `VersionHistoryOperation` | 타입 |
