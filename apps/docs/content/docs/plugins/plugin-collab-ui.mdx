---
title: "Collaboration"
description: "Realtime collaboration: presence cursors, conflict diagnostics, and Yjs CRDT sync. Bundles @anvilkit/plugin-collab-yjs data sync with @anvilkit/collab-ui presence chrome."
---

<div className="anvilkit-plugin-meta">
	<code>@anvilkit/collab-ui</code> <span>·</span> <span>v0.1.0-rc.10</span> <span>·</span> <span>Studio</span> <span>·</span> <span>Headless</span>
</div>
...
<Studio
	puckConfig={config}
	plugins={[createCollabPlugin({ /* options — see the guide below */ })]}
/>;
```
...
| `useCollabUndoState` | Hook |
| `CollabPresenceAnnouncer` | Component / class |
| `CollabPresencePublisher` | Component / class |
| `CollabRoomBar` | Component / class |
| `CollabSettingsPopover` | Component / class |
| `CollabUII18nProvider` | Component / class |
| `CollabUIProvider` | Component / class |
| `CollabUndoRedoControls` | Component / class |
| `ConflictNoticeCenter` | Component / class |
| `ConnectionRecoveryBanner` | Component / class |
| `ForceResyncDialog` | Component / class |
| `PeerAvatarStack` | Component / class |
| `PresenceLayer` | Component / class |
| `SyncActivityIndicator` | Component / class |
| `conflictKey` | Function |
| `CollabPresenceAnnouncerProps` | Type |
| `CollabPresenceLayerProps` | Type |
| `CollabPresencePublisherProps` | Type |
| `CollabRoomBarProps` | Type |
| `CollabSelf` | Type |
| `CollabSettingsPopoverProps` | Type |
| `CollabUIContextValue` | Type |
| `CollabUIProviderProps` | Type |
| `CollabUndoRedoControlsProps` | Type |
| `CollabUndoState` | Type |
| `ConflictNoticeCenterProps` | Type |
| `ConnectionRecoveryBannerLabels` | Type |
| `ConnectionRecoveryBannerProps` | Type |
| `CreateCollabPluginOptions` | Type |
| `ForceResyncDialogLabels` | Type |
| `ForceResyncDialogProps` | Type |
| `PeerAvatarStackProps` | Type |
| `PresencePublishingMode` | Type |
| `SyncActivityIndicatorProps` | Type |
| `SyncActivityLabels` | Type |
