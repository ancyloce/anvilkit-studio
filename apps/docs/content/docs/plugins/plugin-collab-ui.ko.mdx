...
<div className="anvilkit-plugin-meta">
	<code>@anvilkit/collab-ui</code> <span>·</span> <span>v0.1.0-rc.9</span> <span>·</span> <span>Studio</span> <span>·</span> <span>헤드리스</span>
</div>
...
| 패키지 | 버전 범위 | 선택 |
|---------|-------|----------|
| `@hocuspocus/provider` | `^4.1.0` | 예 |
| `@puckeditor/core` | `^0.21.3` | 예 |
| `react` | `>=19.0.0` | 아니오 |
