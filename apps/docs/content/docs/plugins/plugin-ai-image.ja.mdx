...
| `AiDesignJobError` | 型 |
| `AiDesignJobKind` | 型 |
| `AiDesignJobPayload` | 型 |
| `AiDesignJobRequest` | 型 |
| `AiDesignJobResult` | 型 |
| `AiDesignJobStatus` | 型 |
| `AiDesignProvider` | 型 |
| `AiDesignProviderOptions` | 型 |
| `AiDesignQuarantineError` | 型 |
| `AiImageBackgroundReplaceRequest` | 型 |
| `AiImageBgRemoveRequest` | 型 |
| `AiImageGenerativeExpandRequest` | 型 |
| `AiImageGenerativeFillRequest` | 型 |
...
| `AiLayerBounds` | 型 |
| `AiLayerContext` | 型 |
| `AiProviderCapabilities` | 型 |
| `BrandKitDefinition` | 型 |
| `CanvasFactory` | 型 |
| `CommitAiDesignCommandFn` | 型 |
| `CommitAiDesignResultOptions` | 型 |
| `CommitAiDesignResultOutcome` | 型 |
