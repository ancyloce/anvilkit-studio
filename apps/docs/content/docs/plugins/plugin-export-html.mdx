...
<div className="anvilkit-plugin-meta">
	<code>@anvilkit/plugin-export-html</code> <span>·</span> <span>v0.1.8</span> <span>·</span> <span>Export</span> <span>·</span> <span>Header action</span>
</div>
...
Non-optional peers: `react >=19.0.0`, `react-dom >=19.0.0`, `@puckeditor/core ^0.23.0`. Only `@anvilkit/core` is a runtime dependency.
