...
| `buildCanvasSnapshotExportMeta` | Function |
| `buildCanvasSnapshotMeta` | Function |
| `diffCanvasSnapshots` | Function |
...
| `CanvasSnapshotDiff` | Type |
| `CanvasSnapshotExportMeta` | Type |
