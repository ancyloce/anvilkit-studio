...
| `useCollabSelf` | フック |
| `useCollabStatus` | フック |
| `useCollabUndoState` | フック |
| `CollabPresenceAnnouncer` | コンポーネント / クラス |
