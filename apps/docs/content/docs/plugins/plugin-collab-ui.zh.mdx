...
<div className="anvilkit-plugin-meta">
	<code>@anvilkit/collab-ui</code> <span>·</span> <span>v0.1.0-rc.10</span> <span>·</span> <span>Studio</span> <span>·</span> <span>无界面</span>
</div>
