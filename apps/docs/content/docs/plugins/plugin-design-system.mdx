---
title: "Design System"
description: "Token-bound fields, theme switching, and design validation through the `<Studio>` plugin contract."
---

<div className="anvilkit-plugin-meta">
	<code>@anvilkit/plugin-design-system</code> <span>·</span> <span>v0.1.1-rc.2</span> <span>·</span> <span>Studio</span> <span>·</span> <span>Sidebar panel</span>
</div>
...
<Studio
	puckConfig={config}
	plugins={[createDesignSystemPlugin({ /* options — see the guide below */ })]}
/>;
```
...
| Export | Kind |
|--------|------|
| `createDesignSystemPlugin` | Factory |
| `createTokenColorField` | Factory |
| `createTokenSpacingField` | Factory |
| `createTokenTypographyField` | Factory |
| `useTokenContext` | Hook |
| `useTokens` | Hook |
| `useTokenValidationOptions` | Hook |
| `TokenProvider` | Component / class |
| `emitTokensCss` | Function |
| `listTokenRefs` | Function |
| `mergeTokens` | Function |
| `resolveTokenRef` | Function |
| `DEFAULT_TOKENS` | Constant |
| `ColorRamp` | Type |
| `CreateTokenColorFieldOptions` | Type |
| `CreateTokenSpacingFieldOptions` | Type |
| `CreateTokenTypographyFieldOptions` | Type |
| `DarkPrimitiveOverrides` | Type |
| `DesignSystemOptions` | Type |
| `DesignSystemValidationOptions` | Type |
| `DesignTokens` | Type |
| `EmitTokensCssOptions` | Type |
| `PartialDesignTokens` | Type |
| `PrimitiveTokens` | Type |
| `RadiusScale` | Type |
| `ResolvedTokenRef` | Type |
| `SemanticTokens` | Type |
| `SpacingScale` | Type |
| `TokenCategory` | Type |
| `TokenContextValue` | Type |
| `TokenProviderProps` | Type |
| `TokenRefKind` | Type |
| `TypographyScale` | Type |
