...
<div className="anvilkit-plugin-meta">
	<code>@anvilkit/plugin-version-history</code> <span>·</span> <span>v0.1.8</span> <span>·</span> <span>履歴</span> <span>·</span> <span>ヘッダーアクション</span>
</div>
...
| `MaybePromise` | 型 |
| `PeerInfo` | 型 |
| `PrepareRestoreInput` | 型 |
| `PresenceCursor` | 型 |
| `PresenceSelection` | 型 |
| `PresenceState` | 型 |
| `RestoreConflict` | 型 |
| `RestoreConflictInput` | 型 |
| `RetentionAdapter` | 型 |
| `RetentionPlan` | 型 |
| `RetentionPlanOptions` | 型 |
| `RetentionPolicy` | 型 |
| `RetentionResult` | 型 |
| `RunRetentionOptions` | 型 |
| `SnapshotAdapter` | 型 |
...
| `VersionHistoryExport` | 型 |
| `VersionHistoryExportEntry` | 型 |
| `VersionHistoryImportOptions` | 型 |
| `VersionHistoryOperation` | 型 |
