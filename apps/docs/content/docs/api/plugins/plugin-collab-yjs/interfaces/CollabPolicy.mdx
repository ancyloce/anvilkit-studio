...
Defined in: [plugin-collab-yjs/src/types/types.ts:854](https://github.com/ancyloce/anvilkit-studio/blob/main/src/types/types.ts#L854)
...
| ------ | ------ | ------ | ------ |
| &lt;a id="canedit"&gt;&lt;/a&gt; `canEdit` | `readonly` | (`node`, `peer`) =&gt; `boolean` | [plugin-collab-yjs/src/types/types.ts:855](https://github.com/ancyloce/anvilkit-studio/blob/main/src/types/types.ts#L855) |
