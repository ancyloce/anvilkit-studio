...
Defined in: [plugins/plugin-ai-image/src/post-process/pipeline.ts:24](https://github.com/ancyloce/anvilkit-studio/blob/main/src/post-process/pipeline.ts#L24)
