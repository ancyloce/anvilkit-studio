...
Defined in: [components/collab-presence-publisher.tsx:39](https://github.com/ancyloce/anvilkit-studio/blob/main/src/components/collab-presence-publisher.tsx#L39)
