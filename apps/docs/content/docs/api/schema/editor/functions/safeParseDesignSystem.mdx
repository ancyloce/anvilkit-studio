---
title: "safeParseDesignSystem"
description: "@anvilkit/schema · safeParseDesignSystem"
---

```ts
function safeParseDesignSystem(value): ZodSafeParseResult<DesignSystem>;
```

Defined in: [editor/appearance.ts:209](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/foundation/schema/src/editor/appearance.ts#L209)
...
`ZodSafeParseResult`\<`DesignSystem`\>
