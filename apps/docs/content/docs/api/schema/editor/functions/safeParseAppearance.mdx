---
title: "safeParseAppearance"
description: "@anvilkit/schema · safeParseAppearance"
---

```ts
function safeParseAppearance(value): ZodSafeParseResult<AnvilAppearance>;
```

Defined in: [editor/appearance.ts:205](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/foundation/schema/src/editor/appearance.ts#L205)
...
`ZodSafeParseResult`\<`AnvilAppearance`\>
