---
title: "AuthorStyleSchema"
description: "@anvilkit/schema · AuthorStyleSchema"
---

```ts
const AuthorStyleSchema: z.ZodType<AuthorStyle>;
```

Defined in: [editor/appearance.ts:36](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/foundation/schema/src/editor/appearance.ts#L36)
