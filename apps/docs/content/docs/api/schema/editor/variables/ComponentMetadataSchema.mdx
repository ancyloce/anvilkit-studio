---
title: "ComponentMetadataSchema"
description: "@anvilkit/schema · ComponentMetadataSchema"
---

```ts
const ComponentMetadataSchema: z.ZodType<AnvilComponentMetadata>;
```

Defined in: [editor/appearance.ts:161](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/foundation/schema/src/editor/appearance.ts#L161)
