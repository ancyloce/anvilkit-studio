...
description: "@anvilkit/schema · DesignSystemSchema"
---

```ts
const DesignSystemSchema: z.ZodType<DesignSystem>;
```

Defined in: [editor/appearance.ts:54](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/foundation/schema/src/editor/appearance.ts#L54)
