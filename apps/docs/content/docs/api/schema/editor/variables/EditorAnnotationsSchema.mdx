---
title: "EditorAnnotationsSchema"
description: "@anvilkit/schema · EditorAnnotationsSchema"
---

```ts
const EditorAnnotationsSchema: z.ZodType<EditorAnnotations>;
```

Defined in: [editor/appearance.ts:76](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/foundation/schema/src/editor/appearance.ts#L76)
