---
title: "StyleTargetCapabilitySchema"
description: "@anvilkit/schema · StyleTargetCapabilitySchema"
---

```ts
const StyleTargetCapabilitySchema: ZodObject<{
  label: ZodString;
  properties: ZodArray<ZodType<AuthorableStyleProperty, unknown, $ZodTypeInternals<AuthorableStyleProperty, unknown>>>;
  responsive: ZodOptional<ZodBoolean>;
}, $loose>;
```

Defined in: [editor/appearance.ts:136](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/foundation/schema/src/editor/appearance.ts#L136)
