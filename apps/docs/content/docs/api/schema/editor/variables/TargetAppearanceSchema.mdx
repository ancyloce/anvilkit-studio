---
title: "TargetAppearanceSchema"
description: "@anvilkit/schema · TargetAppearanceSchema"
---

```ts
const TargetAppearanceSchema: z.ZodType<TargetAppearance>;
```

Defined in: [editor/appearance.ts:42](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/foundation/schema/src/editor/appearance.ts#L42)
