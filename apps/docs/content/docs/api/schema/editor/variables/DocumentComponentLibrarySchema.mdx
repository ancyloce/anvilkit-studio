---
title: "DocumentComponentLibrarySchema"
description: "@anvilkit/schema · DocumentComponentLibrarySchema"
---

```ts
const DocumentComponentLibrarySchema: z.ZodType<DocumentComponentLibrary>;
```

Defined in: [editor/appearance.ts:86](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/foundation/schema/src/editor/appearance.ts#L86)
