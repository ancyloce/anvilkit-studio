...
from a [PageIR](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/contracts/src/ir.ts).
...
| ------ | ------ | ------ |
| `ir` | [`PageIR`](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/contracts/src/ir.ts) | The page IR document to rehydrate. |
