...
Defined in: [packages/canvas/editor/src/collab/presence-types.ts:10](https://github.com/ancyloce/anvilkit-studio/blob/main/src/collab/presence-types.ts#L10)
