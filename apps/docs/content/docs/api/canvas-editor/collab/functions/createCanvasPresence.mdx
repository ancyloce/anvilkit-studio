...
Defined in: [packages/canvas/editor/src/collab/presence-bridge.ts:49](https://github.com/ancyloce/anvilkit-studio/blob/main/src/collab/presence-bridge.ts#L49)
