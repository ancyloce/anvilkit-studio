...
Defined in: [packages/capabilities/canvas/editor/src/workspace/layout/CanvasToolbar.tsx:198](https://github.com/ancyloce/anvilkit-studio/blob/main/src/workspace/layout/CanvasToolbar.tsx#L198)
