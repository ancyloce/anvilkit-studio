...
Defined in: [packages/capabilities/canvas/editor/src/panels/PropertyInspector.tsx:39](https://github.com/ancyloce/anvilkit-studio/blob/main/src/panels/PropertyInspector.tsx#L39)
