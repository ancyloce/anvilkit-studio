...
Defined in: [packages/capabilities/canvas/editor/src/render/export-stage.ts:146](https://github.com/ancyloce/anvilkit-studio/blob/main/src/render/export-stage.ts#L146)
...
The capture RECTANGLE is passed explicitly (surfaceRect) rather than
