...
Defined in: [packages/capabilities/canvas/editor/src/render/rasterize-page.tsx:88](https://github.com/ancyloce/anvilkit-studio/blob/main/src/render/rasterize-page.tsx#L88)
