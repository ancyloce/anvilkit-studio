...
Defined in: [packages/canvas/editor/src/render/rasterize-page.tsx:51](https://github.com/ancyloce/anvilkit-studio/blob/main/src/render/rasterize-page.tsx#L51)
