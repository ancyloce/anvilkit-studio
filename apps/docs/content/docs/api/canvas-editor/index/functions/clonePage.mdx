...
Defined in: [packages/capabilities/canvas/editor/src/pages/clone-page.ts:44](https://github.com/ancyloce/anvilkit-studio/blob/main/src/pages/clone-page.ts#L44)
