...
Defined in: [packages/capabilities/canvas/editor/src/pages/clone-page.ts:51](https://github.com/ancyloce/anvilkit-studio/blob/main/src/pages/clone-page.ts#L51)
