...
Defined in: [packages/capabilities/canvas/editor/src/workspace/layout/PagesCanvas.tsx:83](https://github.com/ancyloce/anvilkit-studio/blob/main/src/workspace/layout/PagesCanvas.tsx#L83)
