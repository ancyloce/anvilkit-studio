...
Defined in: [packages/canvas/editor/src/workspace/layout/PagesCanvas.tsx:52](https://github.com/ancyloce/anvilkit-studio/blob/main/src/workspace/layout/PagesCanvas.tsx#L52)
