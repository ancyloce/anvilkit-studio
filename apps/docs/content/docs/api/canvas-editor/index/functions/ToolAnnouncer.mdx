...
Defined in: [packages/capabilities/canvas/editor/src/a11y/ToolAnnouncer.tsx:29](https://github.com/ancyloce/anvilkit-studio/blob/main/src/a11y/ToolAnnouncer.tsx#L29)
