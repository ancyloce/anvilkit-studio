...
Defined in: [packages/capabilities/canvas/editor/src/panels/BrandPanel.tsx:102](https://github.com/ancyloce/anvilkit-studio/blob/main/src/panels/BrandPanel.tsx#L102)
