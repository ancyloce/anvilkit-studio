...
Defined in: [packages/capabilities/canvas/editor/src/persistence/recovery.ts:58](https://github.com/ancyloce/anvilkit-studio/blob/main/src/persistence/recovery.ts#L58)
