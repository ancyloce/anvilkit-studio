...
Defined in: [packages/canvas/editor/src/context/canvas-studio-context.tsx:36](https://github.com/ancyloce/anvilkit-studio/blob/main/src/context/canvas-studio-context.tsx#L36)
