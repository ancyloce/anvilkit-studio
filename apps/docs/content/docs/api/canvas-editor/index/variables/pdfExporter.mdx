...
Defined in: [packages/capabilities/canvas/editor/src/header/exporters.ts:388](https://github.com/ancyloce/anvilkit-studio/blob/main/src/header/exporters.ts#L388)
