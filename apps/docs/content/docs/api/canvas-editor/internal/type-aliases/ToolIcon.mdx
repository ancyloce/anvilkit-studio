...
Defined in: [packages/capabilities/canvas/editor/src/tools/tool-types.ts:87](https://github.com/ancyloce/anvilkit-studio/blob/main/src/tools/tool-types.ts#L87)
