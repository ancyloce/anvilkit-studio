...
Defined in: [packages/capabilities/canvas/editor/src/tools/text-tool.ts:20](https://github.com/ancyloce/anvilkit-studio/blob/main/src/tools/text-tool.ts#L20)
