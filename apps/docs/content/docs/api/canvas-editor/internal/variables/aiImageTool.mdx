...
Defined in: [packages/capabilities/canvas/editor/src/tools/ai-image-tool.ts:15](https://github.com/ancyloce/anvilkit-studio/blob/main/src/tools/ai-image-tool.ts#L15)
