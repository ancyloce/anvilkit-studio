...
Defined in: [packages/capabilities/canvas/editor/src/tools/hand-tool.ts:16](https://github.com/ancyloce/anvilkit-studio/blob/main/src/tools/hand-tool.ts#L16)
