...
Defined in: [packages/capabilities/canvas/editor/src/tools/image-tool.ts:43](https://github.com/ancyloce/anvilkit-studio/blob/main/src/tools/image-tool.ts#L43)
