...
Defined in: [packages/capabilities/canvas/editor/src/selection/PathEditOverlay.tsx:29](https://github.com/ancyloce/anvilkit-studio/blob/main/src/selection/PathEditOverlay.tsx#L29)
