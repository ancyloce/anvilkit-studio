...
Defined in: [packages/capabilities/canvas/editor/src/selection/group-actions.ts:83](https://github.com/ancyloce/anvilkit-studio/blob/main/src/selection/group-actions.ts#L83)
