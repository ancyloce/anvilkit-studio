...
Defined in: [packages/capabilities/canvas/editor/src/tools/draw-snap.ts:19](https://github.com/ancyloce/anvilkit-studio/blob/main/src/tools/draw-snap.ts#L19)
