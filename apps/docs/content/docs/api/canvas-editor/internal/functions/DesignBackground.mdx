...
Defined in: [packages/capabilities/canvas/editor/src/stage/DesignBackground.tsx:16](https://github.com/ancyloce/anvilkit-studio/blob/main/src/stage/DesignBackground.tsx#L16)
