...
Defined in: [editor/design-system.ts:52](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/foundation/contracts/src/editor/design-system.ts#L52)
...
| ------ | ------ | ------ | ------ |
| &lt;a id="locked"&gt;&lt;/a&gt; `locked?` | `readonly` | `boolean` | [editor/design-system.ts:54](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/foundation/contracts/src/editor/design-system.ts#L54) |
| &lt;a id="name"&gt;&lt;/a&gt; `name?` | `readonly` | `string` | [editor/design-system.ts:53](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/foundation/contracts/src/editor/design-system.ts#L53) |
