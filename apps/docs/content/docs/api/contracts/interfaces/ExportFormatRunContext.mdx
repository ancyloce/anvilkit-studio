...
Defined in: [export.ts:131](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/contracts/src/export.ts#L131)
...
| ------ | ------ | ------ | ------ |
| &lt;a id="assetresolvers"&gt;&lt;/a&gt; `assetResolvers?` | `readonly` | readonly [`IRAssetResolver`](../type-aliases/IRAssetResolver)[] | [export.ts:132](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/contracts/src/export.ts#L132) |
