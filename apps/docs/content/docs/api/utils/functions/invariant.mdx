---
title: "invariant"
description: "@anvilkit/utils · invariant"
---
...
Defined in: [invariant.ts:24](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/foundation/utils/src/invariant.ts#L24)
...
| ------ | ------ | ------ |
| `condition` | `unknown` | Any value; falsy throws. |
| `message` | `string` | The error message. Should describe the invariant that was violated, not the literal failure mode. |
