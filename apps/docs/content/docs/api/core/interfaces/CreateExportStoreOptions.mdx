...
Defined in: [state/slices/export-store.ts:228](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/core/src/state/slices/export-store.ts#L228)
...
| ------ | ------ | ------ | ------ |
| &lt;a id="storeid"&gt;&lt;/a&gt; `storeId` | `readonly` | `string` | [state/slices/export-store.ts:229](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/core/src/state/slices/export-store.ts#L229) |
