...
Defined in: foundation/contracts/dist/export.d.ts:124
...
| ------ | ------ | ------ | ------ |
| &lt;a id="assetresolvers"&gt;&lt;/a&gt; `assetResolvers?` | `readonly` | readonly [`IRAssetResolver`](../type-aliases/IRAssetResolver)[] | foundation/contracts/dist/export.d.ts:125 |
