...
Defined in: [core/src/runtime/built-in-formats/json-format.ts:17](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/core/src/runtime/built-in-formats/json-format.ts#L17)
