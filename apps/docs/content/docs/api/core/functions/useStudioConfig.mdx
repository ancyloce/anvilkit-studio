...
Defined in: [config/hooks.ts:63](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/core/src/config/hooks.ts#L63)
...
Defined in: [config/hooks.ts:78](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/core/src/config/hooks.ts#L78)
