...
description: "@anvilkit/core · ExportWarningLevel"
---
...
Defined in: [types/export.ts:46](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/core/src/types/export.ts#L46)
