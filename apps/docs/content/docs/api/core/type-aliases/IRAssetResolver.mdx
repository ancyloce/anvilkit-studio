...
description: "@anvilkit/core · IRAssetResolver"
---
...
Defined in: [types/asset-resolver.ts:33](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/core/src/types/asset-resolver.ts#L33)
