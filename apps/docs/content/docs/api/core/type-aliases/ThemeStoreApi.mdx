...
Defined in: [runtime/core/src/state/slices/theme-store.ts:172](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/runtime/core/src/state/slices/theme-store.ts#L172)
