---
title: "ExportOptions"
description: "@anvilkit/core · ExportOptions"
---
...
Defined in: [types/export.ts:115](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/core/src/types/export.ts#L115)
