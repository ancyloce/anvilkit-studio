...
Defined in: [core/src/runtime/lifecycle-manager.ts:130](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/core/src/runtime/lifecycle-manager.ts#L130)
