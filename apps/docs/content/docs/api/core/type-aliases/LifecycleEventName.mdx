...
Defined in: [core/src/runtime/lifecycle-manager.ts:101](https://github.com/ancyloce/anvilkit-studio/blob/main/packages/core/src/runtime/lifecycle-manager.ts#L101)
