---
title: "CanvasComponentVariantAxisSchema"
description: "@anvilkit/canvas-core · CanvasComponentVariantAxisSchema"
---

```ts
const CanvasComponentVariantAxisSchema: ZodObject<{
  defaultValueId: ZodString;
  id: ZodString;
...
Defined in: [ir/component-variants.ts:121](https://github.com/ancyloce/anvilkit-studio/blob/main/src/ir/component-variants.ts#L121)
