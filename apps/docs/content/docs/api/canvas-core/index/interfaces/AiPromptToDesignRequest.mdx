...
Defined in: [ai-design-contracts.ts:42](https://github.com/ancyloce/anvilkit-studio/blob/main/src/ai-design-contracts.ts#L42)
...
| ------ | ------ | ------ | ------ |
| &lt;a id="kind"&gt;&lt;/a&gt; `kind` | `"prompt-to-design"` | - | [ai-design-contracts.ts:43](https://github.com/ancyloce/anvilkit-studio/blob/main/src/ai-design-contracts.ts#L43) |
| &lt;a id="presetid"&gt;&lt;/a&gt; `presetId?` | `string` | A `CanvasSizePreset.id`; omitted lets the provider choose a default canvas size. | [ai-design-contracts.ts:46](https://github.com/ancyloce/anvilkit-studio/blob/main/src/ai-design-contracts.ts#L46) |
| &lt;a id="prompt"&gt;&lt;/a&gt; `prompt` | `string` | - | [ai-design-contracts.ts:44](https://github.com/ancyloce/anvilkit-studio/blob/main/src/ai-design-contracts.ts#L44) |
