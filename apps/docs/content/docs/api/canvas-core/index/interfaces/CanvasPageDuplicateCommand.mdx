...
| ------ | ------ | ------ |
| &lt;a id="name"&gt;&lt;/a&gt; `name?` | `string` | [commands/types.ts:223](https://github.com/ancyloce/anvilkit-studio/blob/main/src/commands/types.ts#L223) |
| &lt;a id="newpageid"&gt;&lt;/a&gt; `newPageId` | `string` | [commands/types.ts:222](https://github.com/ancyloce/anvilkit-studio/blob/main/src/commands/types.ts#L222) |
| &lt;a id="sourcepageid"&gt;&lt;/a&gt; `sourcePageId` | `string` | [commands/types.ts:221](https://github.com/ancyloce/anvilkit-studio/blob/main/src/commands/types.ts#L221) |
| &lt;a id="type"&gt;&lt;/a&gt; `type` | `"page.duplicate"` | [commands/types.ts:220](https://github.com/ancyloce/anvilkit-studio/blob/main/src/commands/types.ts#L220) |
