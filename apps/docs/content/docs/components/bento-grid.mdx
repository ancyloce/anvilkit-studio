---
title: BentoGrid
description: "Anvilkit Puck-native Bento Grid component."
---

<div className="anvilkit-component-meta">
	<code>@anvilkit/bento-grid</code> <span>·</span> <span>v0.2.2</span> <span>·</span> <a href="/playground">Try it in the playground →</a>
</div>
