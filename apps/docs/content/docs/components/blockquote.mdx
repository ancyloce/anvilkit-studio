---
title: Blockquote
description: "Anvilkit Puck-native blockquote component."
---

<div className="anvilkit-component-meta">
	<code>@anvilkit/blockquote</code> <span>·</span> <span>v0.1.0</span> <span>·</span> <a href="/playground">Try it in the playground →</a>
</div>
