---
title: Code
description: "Anvilkit Puck-native code component."
---

<div className="anvilkit-component-meta">
	<code>@anvilkit/code</code> <span>·</span> <span>v0.1.0</span> <span>·</span> <a href="/playground">Try it in the playground →</a>
</div>
