---
title: Section
description: "Anvilkit Puck-native section component."
---

<div className="anvilkit-component-meta">
	<code>@anvilkit/section</code> <span>·</span> <span>v0.2.1</span> <span>·</span> <a href="/playground">Try it in the playground →</a>
</div>
