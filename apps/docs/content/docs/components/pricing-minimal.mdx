...
description: "Anvilkit Puck-native pricing minimal component."
---

<div className="anvilkit-component-meta">
	<code>@anvilkit/pricing-minimal</code> <span>·</span> <span>v0.2.2</span> <span>·</span> <a href="/playground">Try it in the playground →</a>
</div>
