---
title: Navbar
description: "Anvilkit Puck-native navbar component."
---

<div className="anvilkit-component-meta">
	<code>@anvilkit/navbar</code> <span>·</span> <span>v0.2.2</span> <span>·</span> <a href="/playground">Try it in the playground →</a>
</div>
