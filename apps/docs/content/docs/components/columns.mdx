---
title: Columns
description: "Anvilkit Puck-native columns component."
---

<div className="anvilkit-component-meta">
	<code>@anvilkit/columns</code> <span>·</span> <span>v0.1.0</span> <span>·</span> <a href="/playground">Try it in the playground →</a>
</div>
