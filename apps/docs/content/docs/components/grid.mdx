---
title: Grid
description: "Anvilkit Puck-native grid component."
---

<div className="anvilkit-component-meta">
	<code>@anvilkit/grid</code> <span>·</span> <span>v0.1.0</span> <span>·</span> <a href="/playground">Try it in the playground →</a>
</div>
