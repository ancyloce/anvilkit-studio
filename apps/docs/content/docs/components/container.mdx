---
title: Container
description: "Anvilkit Puck-native container component."
---

<div className="anvilkit-component-meta">
	<code>@anvilkit/container</code> <span>·</span> <span>v0.1.0</span> <span>·</span> <a href="/playground">Try it in the playground →</a>
</div>
