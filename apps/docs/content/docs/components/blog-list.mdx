---
title: BlogList
description: "Anvilkit Puck-native blog-list component."
---

<div className="anvilkit-component-meta">
	<code>@anvilkit/blog-list</code> <span>·</span> <span>v0.2.2</span> <span>·</span> <a href="/playground">Try it in the playground →</a>
</div>
