---
title: Heading
description: "Anvilkit Puck-native heading component."
---

<div className="anvilkit-component-meta">
	<code>@anvilkit/heading</code> <span>·</span> <span>v0.1.0</span> <span>·</span> <a href="/playground">Try it in the playground →</a>
</div>
