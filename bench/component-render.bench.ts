...
import {
  BentoGrid,
  defaultProps as bentoGridDefaults,
} from "@anvilkit/bento-grid";
import {
  BlogList,
  defaultProps as blogListDefaults,
...
const CASES: ComponentCase[] = [
  {
    name: "BentoGrid",
    Component: BentoGrid as unknown as ComponentType<Record<string, unknown>>,
    props: bentoGridDefaults as Record<string, unknown>,
  },
  {
    name: "BlogList",
    Component: BlogList as unknown as ComponentType<Record<string, unknown>>,
    props: blogListDefaults as Record<string, unknown>,
  },
  {
    name: "Button",
    Component: Button as unknown as ComponentType<Record<string, unknown>>,
    props: buttonDefaults as Record<string, unknown>,
  },
  {
    name: "Helps",
    Component: Helps as unknown as ComponentType<Record<string, unknown>>,
    props: helpsDefaults as Record<string, unknown>,
  },
  {
    name: "Hero",
    Component: Hero as unknown as ComponentType<Record<string, unknown>>,
    props: heroDefaults as Record<string, unknown>,
  },
  {
    name: "Input",
    Component: Input as unknown as ComponentType<Record<string, unknown>>,
    props: inputDefaults as Record<string, unknown>,
  },
  {
    name: "LogoClouds",
    Component: LogoClouds as unknown as ComponentType<Record<string, unknown>>,
    props: logoCloudsDefaults as Record<string, unknown>,
  },
  {
    name: "Navbar",
    Component: Navbar as unknown as ComponentType<Record<string, unknown>>,
    props: navbarDefaults as Record<string, unknown>,
  },
  {
    name: "PricingMinimal",
    Component: PricingMinimal as unknown as ComponentType<
      Record<string, unknown>
    >,
    props: pricingMinimalDefaults as Record<string, unknown>,
  },
  {
    name: "Section",
    Component: Section as unknown as ComponentType<Record<string, unknown>>,
    props: sectionDefaults as Record<string, unknown>,
  },
  {
    name: "Statistics",
    Component: Statistics as unknown as ComponentType<Record<string, unknown>>,
    props: statisticsDefaults as Record<string, unknown>,
  },
];
