...
export function SnippetRow({
	...
	return (
		<Tooltip>
			<TooltipTrigger
				render={
					<Button
						...
						className={cn(
							"h-auto w-full flex-col items-start gap-0.5 rounded-md border border-transparent px-2 py-1.5 text-start font-normal",
			...
			/>
			<TooltipContent side="right">{snippet.body}</TooltipContent>
		</Tooltip>
	);
}
